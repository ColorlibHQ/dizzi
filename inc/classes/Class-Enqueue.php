 ...
 */
	...
	class dizzi_Enqueue{
		...
		public function dizzi_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'dizzi_frontend_enqueue_scripts', ) );
		}

		public function dizzi_frontend_enqueue_scripts( ){
