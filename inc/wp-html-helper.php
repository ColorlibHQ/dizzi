...
// image default alt
if( !function_exists( 'dizzi_img_default_alt' ) ){
	function dizzi_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'dizzi_img_tag' ) ){
	function dizzi_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'dizzi_anchor_tag' ) ){
	function dizzi_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'dizzi_heading_tag' ) ){
	function dizzi_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'dizzi_paragraph_tag' ) ){
	function dizzi_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'dizzi_other_tag' ) ){
	function dizzi_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'dizzi_button_element ' ) ){
	function dizzi_button_element( array $args ){
