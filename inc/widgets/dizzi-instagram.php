...
----------------------------------------*/
class dizzi_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('dizzi_instagram_photo',esc_html__('[ Dizzi ] Intagram Photo','dizzi'),array(
			'description' => esc_html__('Dizzi Instagram Photo Widget','dizzi'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'dizzi');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'dizzi'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'dizzi'); ?></label>
...
if(!function_exists('dizzi_instagram_widgets')):
	function dizzi_instagram_widgets(){
		register_widget('dizzi_instagram_photo');
	}
	add_action('widgets_init','dizzi_instagram_widgets');
endif;
