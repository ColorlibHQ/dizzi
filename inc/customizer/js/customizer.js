(function( $ , api){
    ...
    api.section( 'dizzi_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'dizzi_about_section' , function( section ){
    ...
    api.section( 'dizzi_blog_section' , function( section ){
    ...
    api.section( 'dizzi_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-dizzi_contact_custom_formshortcode'),
                selector = $('#_customize-input-dizzi_contact_formshortcode');
    ...
    // General section
    api.section( 'dizzi_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#dizzi_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-dizzi_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-dizzi_preloader_color' );
            ...
            var $backtotop          = $( '#dizzi_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-dizzi_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-dizzi_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'dizzi_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#dizzi_footer_widget_toggle');
