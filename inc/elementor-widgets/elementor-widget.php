    ...
    final class Dizzi_El_Widgets {
        ...
        public function enqueue_element_widgets_scripts() {
            ...
            ******************/
            ...
            // dizzi map custom js
            wp_register_script( 'dizzi-map-custom', DIZZI_DIR_ELEMENTOR . 'assets/js/map-custom.js', array(), '1.0-s2', true );

            // dizzi companion main js
            wp_enqueue_script( 'dizzi', DIZZI_DIR_ELEMENTOR . 'assets/js/dizzi-companion-main.js', array( 'dizzi-ui-js' ), '1.0-s2', true );
